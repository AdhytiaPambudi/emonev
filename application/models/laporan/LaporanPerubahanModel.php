<?php
	class LaporanPerubahanModel extends CI_Model{
	...
	$sqlsc="SELECT * FROM ms_data_umum where tahun_anggaran =".$thn_anggaran;
			...
			$cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\">
                        <tr>
                             <td width=\"100%\" align=\"center\" colspan=\"6\">
                                <strong>REALISASI KINERJA PELAKSANAAN APBD PERUBAHAN TA. $thn_anggaran - $kab
     ...
     //                        $sql1="SELECT
					...
					// GROUP BY `a`.`kd_skpd`";
							...
							$sql1 = "SELECT s.tahun_anggaran,s.kd_skpd,s.nm_skpd,sum(a.total_ubah) as anggaran,SUM(a.real_keuangan) as realisasi, (sum(a.real_keuangan)/sum(a.total))*100 as persenKeu,(SUM(persenFisik)/COUNT(ta)) as persenFis 
							FROM 
							ms_skpd s 
							LEFT JOIN
							...
							keuangan$tw as real_keuangan, (keuangan$tw/p.total_ubah)* 100 as persenKeuangan,
							(fisik$tw/p.tvolume_ubah)* 100 as persenFisik,
							ak.nm_sumberdana
							...
							WHERE p.tvolume_ubah <> 0 and ak.nm_sumberdana_ubah in (SELECT nm_sumberdana FROM mapping_sd WHERE thn_anggaran = ".$thn_anggaran." and sts_anggaran = 'Perubahan' and kd_group_sd = ".$_sd.") and ak.ta = ".$thn_anggaran."
							) a 
...
SELECT s.tahun_anggaran,s.kd_skpd,s.nm_skpd,
	sum(dau.total_ubah) as anggaran,SUM(dau.real_keuangan) as realisasi,
 (sum(dau.real_keuangan)/sum(dau.total_ubah))*100 as persenKeu,(SUM(dau.persenFisik)/COUNT(dau.ta)) as persenFis
FROM ms_skpd s
LEFT JOIN
(
SELECT ak.ta, ak.kd_skpd,ak.nm_skpd,ak.kd_program,ak.nm_program,ak.kd_kegiatan,ak.nm_kegiatan,ak.kd_rek5,ak.nm_rek5,
...
ak.nm_sumberdana
 FROM anggarankegiatan ak INNER JOIN trdpo p on ak.ta = p.tahun_anggaran and ak.kd_kegiatan = p.kd_kegiatan and ak.kd_rek5 = p.kd_rek5
LEFT JOIN trdreal r on r.tahun_anggaran = p.tahun_anggaran and r.kd_kegiatan = p.kd_kegiatan AND r.kd_rekening = p.kd_rek5 AND r.no_rinci = p.no_po
WHERE p.tvolume <> 0 and ak.nm_sumberdana in (SELECT nm_sumberdana FROM mapping_sd WHERE thn_anggaran = $thn_anggaran and sts_anggaran = 'Perubahan' and  kd_group_sd = 1) and ak.ta = $thn_anggaran
) dau
...
ak.nm_sumberdana
 FROM anggarankegiatan ak INNER JOIN trdpo p on ak.ta = p.tahun_anggaran and ak.kd_kegiatan = p.kd_kegiatan and ak.kd_rek5 = p.kd_rek5
LEFT JOIN trdreal r on r.tahun_anggaran = p.tahun_anggaran and r.kd_kegiatan = p.kd_kegiatan AND r.kd_rekening = p.kd_rek5 AND r.no_rinci = p.no_po
WHERE p.tvolume <> 0 and ak.nm_sumberdana in (SELECT nm_sumberdana FROM mapping_sd WHERE  thn_anggaran = $thn_anggaran and sts_anggaran = 'Perubahan' and  kd_group_sd = 2) and ak.ta = $thn_anggaran
) dau
ON s.kd_skpd = dau.kd_skpd AND s.tahun_anggaran = dau.ta
...
ak.nm_sumberdana
 FROM anggarankegiatan ak INNER JOIN trdpo p on ak.ta = p.tahun_anggaran and ak.kd_kegiatan = p.kd_kegiatan and ak.kd_rek5 = p.kd_rek5
LEFT JOIN trdreal r on r.tahun_anggaran = p.tahun_anggaran and r.kd_kegiatan = p.kd_kegiatan AND r.kd_rekening = p.kd_rek5 AND r.no_rinci = p.no_po
WHERE p.tvolume <> 0 and ak.nm_sumberdana in (SELECT nm_sumberdana FROM mapping_sd WHERE  thn_anggaran = $thn_anggaran and sts_anggaran = 'Perubahan' and  kd_group_sd = 3) and ak.ta = $thn_anggaran
) dau
ON s.kd_skpd = dau.kd_skpd AND s.tahun_anggaran = dau.ta
...
ak.nm_sumberdana
 FROM anggarankegiatan ak INNER JOIN trdpo p on ak.ta = p.tahun_anggaran and ak.kd_kegiatan = p.kd_kegiatan and ak.kd_rek5 = p.kd_rek5
LEFT JOIN trdreal r on r.tahun_anggaran = p.tahun_anggaran and r.kd_kegiatan = p.kd_kegiatan AND r.kd_rekening = p.kd_rek5 AND r.no_rinci = p.no_po
WHERE p.tvolume <> 0 and ak.nm_sumberdana in (SELECT nm_sumberdana FROM mapping_sd WHERE  thn_anggaran = $thn_anggaran and sts_anggaran = 'Perubahan' and  kd_group_sd = 4) and ak.ta = $thn_anggaran
) dau
ON s.kd_skpd = dau.kd_skpd AND s.tahun_anggaran = dau.ta
...
ak.nm_sumberdana
 FROM anggarankegiatan ak INNER JOIN trdpo p on ak.ta = p.tahun_anggaran and ak.kd_kegiatan = p.kd_kegiatan and ak.kd_rek5 = p.kd_rek5
LEFT JOIN trdreal r on r.tahun_anggaran = p.tahun_anggaran and r.kd_kegiatan = p.kd_kegiatan AND r.kd_rekening = p.kd_rek5 AND r.no_rinci = p.no_po
WHERE p.tvolume <> 0 and ak.nm_sumberdana in (SELECT nm_sumberdana FROM mapping_sd WHERE  thn_anggaran = $thn_anggaran and sts_anggaran = 'Perubahan' and  kd_group_sd = 5) and ak.ta = $thn_anggaran
) dau
ON s.kd_skpd = dau.kd_skpd AND s.tahun_anggaran = dau.ta
...
ak.nm_sumberdana
 FROM anggarankegiatan ak INNER JOIN trdpo p on ak.ta = p.tahun_anggaran and ak.kd_kegiatan = p.kd_kegiatan and ak.kd_rek5 = p.kd_rek5
LEFT JOIN trdreal r on r.tahun_anggaran = p.tahun_anggaran and r.kd_kegiatan = p.kd_kegiatan AND r.kd_rekening = p.kd_rek5 AND r.no_rinci = p.no_po
WHERE p.tvolume <> 0 and ak.nm_sumberdana in (SELECT nm_sumberdana FROM mapping_sd WHERE  thn_anggaran = $thn_anggaran and sts_anggaran = 'Perubahan' and  kd_group_sd = 6) and ak.ta = $thn_anggaran
) dau
ON s.kd_skpd = dau.kd_skpd AND s.tahun_anggaran = dau.ta
...
ak.nm_sumberdana
 FROM anggarankegiatan ak INNER JOIN trdpo p on ak.ta = p.tahun_anggaran and ak.kd_kegiatan = p.kd_kegiatan and ak.kd_rek5 = p.kd_rek5
LEFT JOIN trdreal r on r.tahun_anggaran = p.tahun_anggaran and r.kd_kegiatan = p.kd_kegiatan AND r.kd_rekening = p.kd_rek5 AND r.no_rinci = p.no_po
WHERE p.tvolume <> 0 and ak.nm_sumberdana in (SELECT nm_sumberdana FROM mapping_sd WHERE  thn_anggaran = $thn_anggaran and sts_anggaran = 'Perubahan' and  kd_group_sd = 7) and ak.ta = $thn_anggaran
) dau
ON s.kd_skpd = dau.kd_skpd AND s.tahun_anggaran = dau.ta
...
ak.nm_sumberdana
 FROM anggarankegiatan ak INNER JOIN trdpo p on ak.ta = p.tahun_anggaran and ak.kd_kegiatan = p.kd_kegiatan and ak.kd_rek5 = p.kd_rek5
LEFT JOIN trdreal r on r.tahun_anggaran = p.tahun_anggaran and r.kd_kegiatan = p.kd_kegiatan AND r.kd_rekening = p.kd_rek5 AND r.no_rinci = p.no_po
WHERE p.tvolume <> 0 and ak.nm_sumberdana in (SELECT nm_sumberdana FROM mapping_sd WHERE  thn_anggaran = $thn_anggaran and sts_anggaran = 'Perubahan' and  kd_group_sd in(1,2,3,4,5,6,7)) and ak.ta = $thn_anggaran
) dau
ON s.kd_skpd = dau.kd_skpd AND s.tahun_anggaran = dau.ta
			...
			$cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\">
                        <tr>
                             <td width=\"100%\" align=\"center\" colspan=\"10\">
                                <strong>REKAPITULASI CAPAIAN KINERJA PELAKSANAAN APBDP TA. $thn_anggaran
                                <br>$kab
                                <br>TRIWULAN $tw
                                <br>($nm_skpd)
                                </strong></td>
					...
					foreach ($query->result() as $row)
					{
						...
						$nilaitot=$nilai;
						 ...
						 $cRet    .= " <tr><td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" width=\"10%\" align=\"center\"><b>$noprogRomawi</b></td>                                     
										 <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" ><b>$uraian</b></td>
										 <td style=\"vertical-align:top;border-top: solid 1px black;border-bottom: none;\" align=\"center\"><b>$targetFisik</b></b></td>
                            ...
                            $cRet    .= " <tr><td style=\"vertical-align:top;border-top: solid 1px black;\" width=\"10%\" align=\"center\"><b>$nokeg</b></td>                                     
                                        <td style=\"vertical-align:top;border-top: solid 1px black;\" >$uraian</td>
                                        <td style=\"vertical-align:top;border-top: solid 1px black;\" align=\"center\">$targetFisik</td>
                                        <td style=\"vertical-align:top;border-top: solid 1px black;\" align=\"right\">$targetKeu</td>
                                        <td style=\"vertical-align:top;border-top: solid 1px black;\" align=\"right\">$kontrak</td>
                                        <td style=\"vertical-align:top;border-top: solid 1px black;\" align=\"right\">$realKeu</td>
                                        <td style=\"vertical-align:top;border-top: solid 1px black;\" align=\"center\">$persenKeu</td>
					 ...
					 if ($spacing >= 0) {
						for ($i=0; $i < $spacing ; $i++) { 
							$cRet .="<tr><td style=\"vertical-align:top;\" width=\"5%\" align=\"center\">&nbsp;</td>                            
        ...
        {   
            ...
            group by kd_skpd,nm_skpd,kd_program,nm_program,kd_kegiatan,nm_kegiatan,lokasi,nm_sumberdana,tu_capai,tu_kel,tu_has,tu_capai_ubah,tu_kel_ubah,tu_has_ubah;";
					 ...
					 foreach ($sqlskpd->result() as $rowdns)
					{
                        ...
                        $tu_capai  = $rowdns->tu_capai_ubah;
                        $tu_kel  = $rowdns->tu_kel_ubah;
                        $tu_has  = $rowdns->tu_has_ubah;
                        
                        $pagu  = 'Rp. '.number_format($rowdns->ubah,'2',',','.');
                    }
			...
			$cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\">
                        <tr>
                             <td colspan=\"16\" width=\"100%\" align=\"center\">
                                <strong>LAPORAN REALISASI KINERJA FISIK DAN KEUANGAN <br>PELAKSANAAN APBDP $kab TA. $thn_anggaran</strong>
                            </td>
                        </tr>
                        <tr style=\"border-top:none;border-bottom:none;\">
			...
			$cRet .= "<table style=\"border-collapse:collapse;font-size:5.5pt;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\">
                    ...
                    $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\">
                        <tr style=\"border-top:none;border-bottom:none;\">
                            ...
                            <td colspan=\"8\" width=\"50%\" align=\"left\" style=\"font-size:8pt;border-bottom:none;border-right:none;border-left:none;border-top:none;\">Keterangan :</td>
                            <td colspan=\"7\" width=\"47%\" align=\"left\" style=\"font-size:8pt;border-bottom:none;\">Foto/Gambar Dokumentasi</td>
                        </tr>
                        <tr style=\"border-top:none;border-bottom:none;\">
                            <td width=\"3%\" align=\"center\" style=\"font-size:8pt;border-top:none;border-bottom:none;border-right:none;border-left:none;\"></td>
                            <td colspan=\"8\" width=\"50%\" align=\"left\" style=\"font-size:8pt;border-top:none;border-bottom:none;border-right:none;border-left:none;\">
...
$dataGambar = $this->db->query($queryGambar)->result();
                    $cRet .="<td colspan=\"7\" width=\"47%\" align=\"left\" style=\"font-size:8pt;border-top:none;\">";
          ...
          foreach ($sqlSearch as $arrKeg) {
           ...
           group by kd_skpd,nm_skpd,kd_program,nm_program,kd_kegiatan,nm_kegiatan,lokasi,nm_sumberdana,tu_capai,tu_kel,tu_has,tu_capai_ubah,tu_kel_ubah,tu_has_ubah;";
            ...
            $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\">
                        <tr>
                             <td colspan=\"16\" width=\"100%\" align=\"center\">
                                <strong>LAPORAN REALISASI KINERJA FISIK DAN KEUANGAN <br>PELAKSANAAN APBD PERUBAHAN $kab TA. $thn_anggaran</strong>
                            </td>
                        </tr></table>";
			$cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"0\" cellpadding=\"4\">
                        <tr style=\"border-top:none;border-bottom:none;\">
...
$dataGambar = $this->db->query($queryGambar)->result();
                    ...
                    $cRet.="</td>
                        ...
                        <tr>
                             <td colspan=\"16\" width=\"100%\" align=\"center\" style=\"font-size:8pt;border-bottom:none;border-right:none;border-left:none;border-top:none;\">
                                &nbsp;
                            </td>
                        </tr>
                        <tr>
