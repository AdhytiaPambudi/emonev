<?php
	class WasTeknisModel extends CI_Model{
		...
		public function add_parameter($data){
			$this->db->insert('ms_was_teknis', $data);
			return true;
		}
		...
		public function get_all_tipe(){
			...
			$this->db->order_by('kd_urusan','desc');
			$query = $this->db->get();
			return $result = $query->result_array();
			
		}

		public function get_all_jns(){
			$this->db->select('*');
			$this->db->from('ms_jenis_pelayanan');
			$query = $this->db->get();
			return $result = $query->result_array();
		}
									...
									<table border = "0" width = "100%" style="border-top: 1px dotted black;border-bottom: 1px dotted black;">
											<tr>
												...
												<td width="10%" style="font-size:16px;">
													...
													<span><i class="fa fa-pencil ic-w mx-1 pull-right showModal" style="padding-top:2px;padding-right:5px;" data-aksi="edit" data-level ="'.$value1["clevel"].'" data-jns = "'.$value1["jns_pelayanan"].'" data-tipe = "'.$value1["tipe_urusan"].'"  data-id = "'.$value1["id_parameter"].'" data-header ="'.$value1["hd_parameter"].'" data-hd ="'.$value1["hd"].'" data-ket ="'.$value1["ket"].'" data-nama ="'.$value1["nm_parameter"].'" data-toggle="tooltip" title="Edit Parameter"></i></span>
						...
						$html .= '<a class="closed">
									<table border = "0" width = "100%" style="border-top: 1px dotted black;border-bottom: 1px dotted black;">
											<tr>
												...
												<td width="10%" style="font-size:16px;">
													<span><i class="fa fa-trash ic-w mx-1 pull-right tombol-hapus" style="padding-top:2px;padding-right:5px;" data-id = "'.$value1["id_parameter"].'" data-nama = "'.$value1["nm_parameter"].'" data-tahun = "'.$value1["tahun"].'" data-aksi="hapus" data-toggle="tooltip" title="Hapus Parameter"></i></span>
													<span><i class="fa fa-pencil ic-w mx-1 pull-right showModal" style="padding-top:2px;padding-right:5px;" data-aksi="edit" data-jns = "'.$value1["jns_pelayanan"].'" data-tipe = "'.$value1["tipe_urusan"].'"  data-level ="'.$value1["clevel"].'" data-id = "'.$value1["id_parameter"].'" data-header ="'.$value1["hd_parameter"].'" data-hd ="'.$value1["hd"].'" data-ket ="'.$value1["ket"].'" data-nama ="'.$value1["nm_parameter"].'" data-toggle="tooltip" title="Edit Parameter"></i></span>
													<span><i class="fa fa-plus ic-w mx-1 pull-right showModal" style="padding-top:2px;padding-right:5px;" data-aksi="tambah" data-level ="2" data-header ="'.$value1["id_parameter"].'" data-hd ="H" data-ket ="Sub Parameter" data-toggle="tooltip" title="Tambah Sub Parameter"></i></span>
												</td>
											</tr>
										</table> 
													...
													<table border = "0" width = "100%" style="border-top: 1px dotted black;border-bottom: 1px dotted black;">
														<tr>
															...
															<td width="10%" style="font-size:12px;">
																<span><i class="fa fa-trash ic-w mx-1 pull-right tombol-hapus" data-id = "'.$value3["id_parameter"].'" data-nama = "'.$value3["nm_parameter"].'" data-tahun = "'.$value3["tahun"].'" style="padding-top:2px;padding-right:5px;" data-aksi="hapus" data-toggle="tooltip" title="Hapus Sub Parameter 2"></i></span>
		...
		public function edit_parameter($data, $id, $thn){
			...
			$this->db->where('tahun', $thn);
			$this->db->update('ms_was_teknis', $data);
			return true;
		}
