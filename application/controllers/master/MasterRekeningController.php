<?php
	...
	class MasterRekeningController extends CI_Controller {

		public function __construct(){
			parent::__construct();
			$this->load->model('master/MasterRekeningModel', 'master_model');
		}

		public function rekening1(){
			$data['view'] = 'master/rekening/rekening1View';
			$this->load->view('template/layout', $data);
        }
        
        public function get_rekening1() {
			$list = $this->master_model->get_all_rek1();
	        $data = array();
	        $no = $_POST['start'];
	        foreach ($list as $field) {
	            ...
	            $row = array();
	            $row[] = $no;
	            $row[] = '<a href="'.base_url("master-rekening-2?parent=".$field->kd_rek1).'" data-id="'.$field->kd_rek1.'" data-nama="'.$field->nm_rek1.'">'.$field->kd_rek1.'</a>';
	            $row[] = '<a href="'.base_url("master-rekening-2?parent=".$field->kd_rek1).'" data-id="'.$field->kd_rek1.'" data-nama="'.$field->nm_rek1.'">'.$field->nm_rek1.'</a>';
	            $row2[] = '<center>
		 	    	<a href="#" class="btn btn-info btn-flat btn-xs edit" data-id="'.$field->kd_rek1.'" data-nama="'.$field->nm_rek1.'"><i class="fa fa-pencil-square-o" aria-hidden="true" data-toggle="tooltip" title="Edit"></i></a>
		 	    	<a href="#" class="dropdown-item btn btn-danger btn-flat btn-xs tombol-hapus" data-id="'.$field->kd_rek1.'" data-nama="'.$field->nm_rek1.'" data-toggle="tooltip" title="Hapus"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
		 	    	</center>';
	            $data[] = $row;
	        }
	        ...
	        $output = array(
	            "draw" => $_POST['draw'],
	            "recordsTotal" => $this->master_model->count_all_rek1(),
	            "recordsFiltered" => $this->master_model->count_filtered_rek1(),
	            "data" => $data,
	        );
        ...
        public function rekening2(){
			$data['view'] = 'master/rekening/rekening2View';
			$this->load->view('template/layout', $data);
        }
        
        public function get_rekening2() {
            $parent = $_GET['parent'];
			$list = $this->master_model->get_all_rek2($parent);
	        $data = array();
	        $no = $_POST['start'];
	        foreach ($list as $field) {
	            $no++;
	            $row = array();
	            $row[] = $no;
	            $row[] = '<a href="'.base_url("master-rekening-3?parent=".$field->kd_rek2).'" data-id="'.$field->kd_rek2.'" data-nama="'.$field->nm_rek2.'">'.$field->kd_rek2.'</a>';
	            $row[] = '<a href="'.base_url("master-rekening-3?parent=".$field->kd_rek2).'" data-id="'.$field->kd_rek2.'" data-nama="'.$field->nm_rek2.'">'.$field->nm_rek2.'</a>';
	            $row2[] = '<center>
		 	    	<a href="#" class="btn btn-info btn-flat btn-xs edit" data-id="'.$field->kd_rek1.'" data-nama="'.$field->nm_rek1.'"><i class="fa fa-pencil-square-o" aria-hidden="true" data-toggle="tooltip" title="Edit"></i></a>
		 	    	<a href="#" class="dropdown-item btn btn-danger btn-flat btn-xs tombol-hapus" data-id="'.$field->kd_rek1.'" data-nama="'.$field->nm_rek1.'" data-toggle="tooltip" title="Hapus"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
		 	    	</center>';
	        ...
	        $output = array(
	            "draw" => $_POST['draw'],
	            "recordsTotal" => $this->master_model->count_all_rek2($parent),
	            "recordsFiltered" => $this->master_model->count_filtered_rek2($parent),
	            "data" => $data,
	        );
	        echo json_encode($output);
		}
        ...
        public function rekening3(){
			$data['view'] = 'master/rekening/rekening3View';
			$this->load->view('template/layout', $data);
        }
        
        public function get_rekening3() {
            $parent = $_GET['parent'];
			$list = $this->master_model->get_all_rek3($parent);
	        $data = array();
	        $no = $_POST['start'];
	        foreach ($list as $field) {
	            $no++;
	            $row = array();
	            $row[] = $no;
	            $row[] = '<a href="'.base_url("master-rekening-4?parent=".$field->kd_rek3).'" data-id="'.$field->kd_rek3.'" data-nama="'.$field->nm_rek3.'">'.$field->kd_rek3.'</a>';
	            $row[] = '<a href="'.base_url("master-rekening-4?parent=".$field->kd_rek3).'" data-id="'.$field->kd_rek3.'" data-nama="'.$field->nm_rek3.'">'.$field->nm_rek3.'</a>';
	            $row2[] = '<center>
		 	    	<a href="#" class="btn btn-info btn-flat btn-xs edit" data-id="'.$field->kd_rek3.'" data-nama="'.$field->nm_rek3.'"><i class="fa fa-pencil-square-o" aria-hidden="true" data-toggle="tooltip" title="Edit"></i></a>
		 	    	<a href="#" class="dropdown-item btn btn-danger btn-flat btn-xs tombol-hapus" data-id="'.$field->kd_rek3.'" data-nama="'.$field->nm_rek3.'" data-toggle="tooltip" title="Hapus"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
		 	    	</center>';
	            $data[] = $row;
	        }
	        ...
	        $output = array(
	            "draw" => $_POST['draw'],
	            "recordsTotal" => $this->master_model->count_all_rek3($parent),
	            "recordsFiltered" => $this->master_model->count_filtered_rek3($parent),
	            "data" => $data,
	        );
	        echo json_encode($output);
		}
        ...
        public function rekening4(){
			$data['view'] = 'master/rekening/rekening4View';
			$this->load->view('template/layout', $data);
        }
        
        public function get_rekening4() {
            $parent = $_GET['parent'];
			$list = $this->master_model->get_all_rek4($parent);
	        $data = array();
	        $no = $_POST['start'];
	        foreach ($list as $field) {
	            $no++;
	            $row = array();
	            $row[] = $no;
	            $row[] = '<a href="'.base_url("master-rekening-5?parent=".$field->kd_rek4).'" data-id="'.$field->kd_rek4.'" data-nama="'.$field->nm_rek4.'">'.$field->kd_rek4.'</a>';
	            $row[] = '<a href="'.base_url("master-rekening-5?parent=".$field->kd_rek4).'" data-id="'.$field->kd_rek4.'" data-nama="'.$field->nm_rek4.'">'.$field->nm_rek4.'</a>';
	            $row2[] = '<center>
		 	    	<a href="#" class="btn btn-info btn-flat btn-xs edit" data-id="'.$field->kd_rek4.'" data-nama="'.$field->nm_rek4.'"><i class="fa fa-pencil-square-o" aria-hidden="true" data-toggle="tooltip" title="Edit"></i></a>
		 	    	<a href="#" class="dropdown-item btn btn-danger btn-flat btn-xs tombol-hapus" data-id="'.$field->kd_rek4.'" data-nama="'.$field->nm_rek4.'" data-toggle="tooltip" title="Hapus"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
		 	    	</center>';
	            $data[] = $row;
	        }
	        ...
	        $output = array(
	            "draw" => $_POST['draw'],
	            "recordsTotal" => $this->master_model->count_all_rek4($parent),
	            "recordsFiltered" => $this->master_model->count_filtered_rek4($parent),
	            "data" => $data,
	        );
	        echo json_encode($output);
        }
        ...
        public function rekening5(){
			$data['view'] = 'master/rekening/rekening5View';
			$this->load->view('template/layout', $data);
        }
        
        public function get_rekening5() {
            $parent = $_GET['parent'];
			$list = $this->master_model->get_all_rek5($parent);
	        $data = array();
	        $no = $_POST['start'];
	        foreach ($list as $field) {
	            $no++;
	            ...
	            $row[] = $field->nm_rek5;
	            $row2[] = '<center>
		 	    	<a href="#" class="btn btn-info btn-flat btn-xs edit" data-id="'.$field->kd_rek5.'" data-nama="'.$field->nm_rek5.'"><i class="fa fa-pencil-square-o" aria-hidden="true" data-toggle="tooltip" title="Edit"></i></a>
		 	    	<a href="#" class="dropdown-item btn btn-danger btn-flat btn-xs tombol-hapus" data-id="'.$field->kd_rek5.'" data-nama="'.$field->nm_rek5.'" data-toggle="tooltip" title="Hapus"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
		 	    	</center>';
	            $data[] = $row;
	        }
	        ...
	        $output = array(
	            "draw" => $_POST['draw'],
	            "recordsTotal" => $this->master_model->count_all_rek5($parent),
	            "recordsFiltered" => $this->master_model->count_filtered_rek5($parent),
	            "data" => $data,
	        );
	        echo json_encode($output);
		}
		...
		public function get_pk_skpd() {
			$list = $this->master_model->get_all_pk_skpd();
	        $data = array();
	        $no = $_POST['start'];
	        foreach ($list as $field) {
	            $no++;
