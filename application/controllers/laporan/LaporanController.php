<?php
	...
	class LaporanController extends CI_Controller {
		...
		public function __construct(){
			parent::__construct();
            $this->load->model('laporan/LaporanModel', 'lap_mod');
        ...
        public function rekapitulasi_kab(){
			$data['view'] = 'laporan/rekapitulasiKabView';
        ...
        public function rekapitulasi_excel($skpd = '',$tw='')
		{
			...
			$data['filename'] = 'Rekapitulasi_Capaian_Kinerja_TW'.$tw.'_'.$skpdFile.'.xls';
            $this->load->view('laporan/excel', $data);
        }
        

        public function rekapitulasi(){
			$data['view'] = 'laporan/rekapitulasiView';
			$this->load->view('template/layout', $data);
        }

        public function realisasi_detail_kegiatan(){
			$data['view'] = 'laporan/realisasiDetailKegiatanView';
			$this->load->view('template/layout', $data);
        }
        ...
        public function realisasi_detail_kegiatan_excel($skpd = '',$keg = '',$tw='')
		{
            ...
            $data['filename'] = 'Realisasi_Capaian_Kinerja_TW'.$tw.'_'.$skpdFile.'_'.$kegFile.'.xls';
            $this->load->view('laporan/excel', $data);
        }
