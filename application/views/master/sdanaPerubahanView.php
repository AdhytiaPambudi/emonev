                        ...
                        <div class="hpanel shadow-inner responsive-mg-b-30">
                            <div class="panel-body"  style = "min-height:550px;">
                                ...
                                <ul class="mailbox-list">
                                    ...
                                    <li>
                                        <a href="<?=base_url('sumber-dana'); ?>" class="listTriwulan" data-id="1">
                                            Sumber Dana (Murni)
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?=base_url('sumber-dana-perubahan'); ?>" class="listTriwulan" data-id="2" style="border: 1px solid red;" >
                        ...
                        <div class="hpanel email-compose" style = "min-height:550px;">
                            <div class="panel-heading hbuilt">
                                <div class="p-xs h4" style="text-align:center;">
                                    <h4 style="text-align:center;" id="judul-form">List Sumber Dana (Perubahan)</h4>
...
<script type="text/javascript">
    ...
    $(window).on('load', function () {
        ...
        $.ajax({
              url: "<?php echo site_url('get-sumber-dana-perubahan');?>",
              type: 'POST',
