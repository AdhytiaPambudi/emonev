                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                     <div class="product-status-wrap" style="min-height:450px;">
                                        <h4 style="text-align:center;color:#006df0;" id="judul-form">List Kegiatan</h4>
                                        ...
                                        <div class="btn-group ib-btn-gp active-hook mail-btn-sd mg-b-15">
                                            ...
                                            <a class="btn btn-default btn-sm" href="<?=base_url('program-kegiatan/program?skpd=').$skpd->kd_skpd.'&bidang='.$bidang->kd_urusan;?>"><?=$bidang->kd_urusan.' . '.$bidang->nm_urusan; ?></a>
                                            <a class="btn btn-primary btn-sm" href="#"><?=$program->kd_program.' . '.$program->nm_program; ?></a>
                                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tablekegiatan = $('#table-kegiatan').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('get-pk-kegiatan/').$skpd->kd_skpd.'/'.$bidang->kd_urusan.'/'.$program->kd_program;?>",
                "type": "POST"
            },
        ...
        function reload_table () {
            tablekegiatan.ajax.reload( null, false ); // user paging is not reset on reload
        }
