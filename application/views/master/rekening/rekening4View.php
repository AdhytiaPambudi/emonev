<?php
    ...
    $dataRek3 = $this->db->query("SELECT kd_rek3,nm_rek3 FROM ms_rek3 where kd_rek3 = ".$parent)->row();
?>
                ...
                <div class="product-payment-inner-st">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <h4 style="text-align:center;color:#006df0;" id="judul-form">Rekening Objek</h4>
                                ...
                                <div class="btn-group ib-btn-gp active-hook mail-btn-sd mg-b-15">
                                    ...
                                    <a class="btn btn-primary btn-sm" href="#"><?=$dataRek3->nm_rek3;?></a>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tableskpd = $('#table-rekening').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('get-rekening-4?parent='.$parent)?>",
                "type": "POST"
            },
