<?php
    ...
    $dataRek2 = $this->db->query("SELECT kd_rek2,nm_rek2 FROM ms_rek2 where kd_rek2 = ".substr($parent,0,2))->row();
    $dataRek3 = $this->db->query("SELECT kd_rek3,nm_rek3 FROM ms_rek3 where kd_rek3 = ".substr($parent,0,3))->row();
    $dataRek4 = $this->db->query("SELECT kd_rek4,nm_rek4 FROM ms_rek4 where kd_rek4 = ".$parent)->row();
?>
                ...
                <div class="product-payment-inner-st">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <h4 style="text-align:center;color:#006df0;" id="judul-form">Rekening Rincian Objek</h4>
                                ...
                                <div class="btn-group ib-btn-gp active-hook mail-btn-sd mg-b-15">
                                    ...
                                    <a class="btn btn-default btn-sm" href="<?= base_url('master-rekening-3?parent='.$dataRek2->kd_rek2);?>"><?=$dataRek2->nm_rek2;?></a>
                                    <a class="btn btn-default btn-sm" href="<?= base_url('master-rekening-4?parent='.$dataRek3->kd_rek3);?>"><?=$dataRek3->nm_rek3;?></a>
                                    <a class="btn btn-primary btn-sm" href="#"><?=$dataRek4->nm_rek4;?></a>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tableskpd = $('#table-rekening').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('get-rekening-5?parent='.$parent)?>",
                "type": "POST"
            },
