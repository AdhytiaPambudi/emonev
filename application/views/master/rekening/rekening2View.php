<?php
    $parent = $_GET['parent'];
    $dataRek1 = $this->db->query("SELECT kd_rek1,nm_rek1 FROM ms_rek1 where kd_rek1 = ".$parent)->row();
?>
                ...
                <div class="product-payment-inner-st">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <h4 style="text-align:center;color:#006df0;" id="judul-form">Rekening Kelompok</h4>
                                ...
                                <div class="btn-group ib-btn-gp active-hook mail-btn-sd mg-b-15">
                                    ...
                                    <a class="btn btn-primary btn-sm" href="#"><?=$dataRek1->nm_rek1;?></a>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tableskpd = $('#table-rekening').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('get-rekening-2?parent='.$parent)?>",
                "type": "POST"
            },
