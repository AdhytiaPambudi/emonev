                        ...
                        <div class="hpanel shadow-inner responsive-mg-b-30">
                            <div class="panel-body"  style = "min-height:550px;">
                                ...
                                <ul class="mailbox-list">
                                    ...
                                    <li>
                                        <a href="#" class="listDPA" data-id="dpaSkpd22">
											<i class="fa fa-file"></i> DPA SKPD 22
										</a>
                                    </li>
                                    <li>
                                        <a href="#" class="listDPA" data-id="dpaSkpd221">
											<i class="fa fa-file"></i> DPA SKPD 221
										</a>
                                    </li>
                                ...
                                <div class="p-xs">
                                    <form method="get" class="form-horizontal">
                                        <div class="form-group" id="combo-skpd">
                                            ...
                                            <input id="jnsLaporan" type="text" class="form-control input-sm hidden" value = "dpaSkpd22">
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    $(document).on("click", ".listDPA", function() {
        
        var id = $(this).attr('data-id');
        if(id == 'dpaSkpd22'){
            $('#combo-kegiatan').attr('class','hidden');
            $('#namaLaporan').html('DPA SKPD 22');
            $('#jnsLaporan').val(id);
        }else if(id == 'dpaSkpd221'){
            $('#namaLaporan').html('DPA SKPD 221');
    ...
    $(document).on("click", ".cetakLaporan", function() {
        ...
        if (id == 'dpaSkpd22') {
            if(output == 'pdf'){
                window.open('<?php echo base_url('dpa22-pdf'); ?>/'+skpd+'?orientation='+ori+'&margins='+mar+'&spacing='+space, '_blank');	
            }else{
                window.open('<?php echo base_url('dpa22-excel'); ?>/'+skpd, '_blank');	
            }
            
        }else if (id == 'dpaSkpd221') {
            if(output == 'pdf'){
                window.open('<?php echo base_url('dpa221-pdf'); ?>/'+skpd+'/'+kegiatan+'?orientation='+ori+'&margins='+mar+'&spacing='+space, '_blank');	
            }else{
                window.open('<?php echo base_url('dpa221-excel'); ?>/'+skpd+'/'+kegiatan, '_blank');	
            }
        }else{
