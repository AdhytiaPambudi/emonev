                                ...
                                <tr>
                                    ...
                                    <td style="width:5%;text-align: center;">
                                      <div class="inputWrapper" data-toggle="tooltip" title="Cari File">
                                        <input type="file" class="fileInput fileInputRAB" onchange="validateFormat(this)" name="fileRAB" id="fileRAB"/>
                                      </div>
                                    </td>  
                                    <td>
                                      <input type="text" name="rab" id="rab" class="form-control input-sm" readonly placeholder="Pilih File (Akan Terisi Otomatis)">
                                    </td>
                                    <td style="width:5%;text-align: center;">
                                      <div class="inputWrapper" data-toggle="tooltip" title="Cari File">
                                        <input type="file" class="fileInput fileInputKontrak" onchange="validateFormat(this)" name="fileSampul" id="fileKontrak"/>
                                      </div>
                                    </td>  
                                    <td>
                                      <input type="text" name="sampul" id="sampul" class="form-control input-sm" readonly placeholder="Pilih File (Akan Terisi Otomatis)">
                                    </td>
                                    <td>
                                    ...
                                    <td rowspan="2" style="vertical-align:middle;">
                                      ...
                                      <center>
                                        ...
                                        <input type="submit"  value="UPLOAD" id="upload_setor" class="fileInput" aksi = "justFileKontrak">
                                      </div>
                                      </center>
                                    </td>  
                                </tr>
...
<script type="text/javascript">
    ...
    $('#form-pemantauan').submit(function(e) {
        ...
        if (ev == 'justFile') {
            ...
            // }else{
              ...
              $.ajax({
                method: 'POST',
                url: '<?php echo base_url('input-data-pemantauan-kontrak'); ?>',
                data: new FormData(this),
                contentType:false,
                cache : false,
                processData:false,
              ...
              .done(function(data) {
                var out = jQuery.parseJSON(data);
                $("#isi_kontrak").html(out.tableKontrak);
                Swal.fire({
                  position: 'top-end',
                  icon: 'success',
                  title: out.pesan,
                ...
                var inputFile = $("#fileRAB");
                inputFile.replaceWith(inputFile.val('').clone(true));
                var inputFile2 = $("#fileKontrak");
     ...
     $(document).on("click", ".hapus-kontrak", function() {
              
              var thn       = $(this).attr("data-thn");
              var keg       = $(this).attr("data-keg");
              var rek       = $(this).attr("data-rek");
              var po        = $(this).attr("data-po");
              var kd_kontrak        = $(this).attr("data-kontrak");
               ...
               Swal.fire({
                  ...
                  if (result.value) {
                       ...
                       $.ajax({
                      method: 'POST',
                      url: '<?php echo base_url('del-data-pemantauan-kontrak'); ?>?thn='+thn+'&keg='+keg+'&rek='+rek+'&po='+po+'&kd_kontrak='+kd_kontrak,
                    })
                    .done(function(data) {
    ...
    $(".fileInputRAB").change(function(){

        var namaFile = $('#fileRAB').val();
        var namaLamp = namaFile.replace("C:\\fakepath\\", "");
        $('#rab').val(namaLamp);
    });

    $(".fileInputKontrak").change(function(){

        var namaFile = $('#fileKontrak').val();
        var namaLamp = namaFile.replace("C:\\fakepath\\", "");
        $('#sampul').val(namaLamp);
    });
