...
<div class="panel panel-headline panel-primary" style="min-height:550px;">
	<div class="panel-heading">
		<h3 class="panel-title">Data TLHP Kemendagri</h3>
	</div>
	<div class="panel-body">
		<div class="row">
			<div class="col-md-12">
				<div class="pull-right <?=$hidden; ?>">
					<a href="<?=base_url('tlhp-kemendagri/add'); ?>" type="button" name="tambah" id="tambah" class="btn btn-primary btn-lg"><i class="fa fa-plus"></i> Tambah</a>
				</div>
				<br>
				...
				<thead>
					<tr>
					  ...
					  <th width="20%" class="text-center">INSTANSI</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#example1').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('tlhp-kemendagri/getTable')?>",
                "type": "POST"
            },
        ...
        $(document).on("click", ".tlanjut", function() {
        	...
        	document.location.href = '<?php echo base_url('tlhp-kemendagri/tindak-lanjut'); ?>?noreg='+noreg+'&no_lhp='+no_lhp;
...
<script type="text/javascript">
	...
	$(document).on("click", ".tombol-hapus", function() {
        ...
        Swal.fire({
		  ...
		  if (result.value) {
		    document.location.href = "<?= base_url('tlhp-kemendagri/del?'); ?>noreg="+noreg+"&lhp="+lhp;
		  }
		})
	...
	$(document).on("click", ".edit-tlhp", function() {
		...
		var lhp 		= $(this).attr("data-lhp");
        var nama 	= $(this).attr("data-nama");
		document.location.href = "<?= base_url('tlhp-kemendagri/edit?'); ?>noreg="+noreg+"&lhp="+lhp;
	});
	...
	$(document).on("click", ".cetak-tlhp", function() {
		...
		swalWithBootstrapButtons.fire({
		  ...
		  if (result.value) {
		    ...
		    window.open('<?php echo base_url("tlhp-kemendagri/excel"); ?>?noreg='+noreg+'&lhp='+lhp, '_blank');	
		  } else if (
		    /* Read more about handling dismissals below */
		    result.dismiss === Swal.DismissReason.cancel
		  ) {
		  	
		        window.open('<?php echo base_url("tlhp-kemendagri/pdf"); ?>?noreg='+noreg+'&lhp='+lhp, '_blank');	
