									...
									<div class="box-body my-form-body">
										<form class="form-horizontal" id="form-lhp">
											<div class="form-group">
											  ...
											  <a href="<?= base_url('tlhp-kemendagri');?>" class="btn btn-default btn-lg">Kembali</a>
											  </center>
										...
										<!-- <form class="form-horizontal" id="form-temuan"> -->
											...
											<!-- <div class="form-group">
											  ...
											  <center>
												  ...
												  <a href="<?= base_url('tlhp-kemendagri');?>" class="btn btn-default btn-lg">Tutup</a>
											  </center> -->
										<!-- </form> -->
									</div>
								</div>
...
function kirimChat () {
	...
	$.ajax({
      method: 'POST',
      url: '<?php echo base_url('tlhp-kemendagri/insert-catatan'); ?>',
...
$(window).on('load', function () {
	...
	$(document).ready(function() {
  	...
  	$.ajax({
		  url: '<?php echo base_url('tlhp-kemendagri/get_tree_temuan'); ?>',
		  type: 'POST',
