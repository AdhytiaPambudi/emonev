...
<div class="panel panel-headline  panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">FORM EDIT TLHP PEMDA</h3>
	</div>
											...
											<div class="form-group">
											  ...
											  <div class="form-group">
												...
												<div class="col-sm-4">
												  ...
												  <input type="text" name="pembahas_obrik" class="form-control input-sm" id="pembahas_obrik" placeholder="Isi Nama Petugas Daerah" required value="<?=$obrik; ?>">
												</div>
											  </div>
											  <div class="form-group">
											  ...
											  <button type="button"  data-aksi="new" class="btn btn-primary btn-lg simpan hidden">INPUT BARU</button>
											  </center>
											...
											<table id="list-data" class="table table-bordered table-striped;" style="background-color:#ccc;">
									                  ...
									                  <tbody>
									                  	...
									                  	<tr>
									                  		...
									                  		<td><label>Petugas Sekratariat</label></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	...
      	<div class="btn-group btn-group-justified" role="group" aria-label="...">
			...
			<a href="<?= base_url('tlhp-pemda/tindak-lanjut'.'?noreg='.$noreg.'&no_lhp='.$no_lhp); ?>" class="btn btn-default btn-lg">Lanjut ke TLHP <i class="fa fa-arrow-circle-right"></i></a>
		</div>
...
$(window).on('load', function () {
	...
	var jns='umum';
		...
		// $('#form-lhp').submit(function(e) {
		    ...
		    if (pembahas_obrik == '') {
		    	Swal.fire({position: 'top-end',icon: 'warning',title: 'DATA PETUGAS DAERAH OBRIK BELUM DIISI',showConfirmButton: false,timer: 2000});
				exit();
		    }
		    if (review == '') {
