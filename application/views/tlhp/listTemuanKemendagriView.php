          ...
          <div class="row">
            <div class="col-sm-8">
              ...
              <form class="form-horizontal" id="form-tl" enctype="multipart/form-data" method="post">
                  ...
                  <div class="col-sm-9">
                  <textarea name="rekomendasi" class="form-control input-sm" id="rekomendasi" maxlength="500" placeholder="" value="" readonly=""></textarea>
                  </div>
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <textarea name="tlanjut" class="form-control input-sm" id="tlanjut" maxlength="500" placeholder="" value=""></textarea>
                  </div>
                </div>
                  <div class="form-group row">
