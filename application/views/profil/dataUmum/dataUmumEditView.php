                        ...
                        <div class="sparkline12-list">
                            <div class="sparkline12-hd">
                                <div class="main-sparkline12-hd">
                                    <h4 style="text-align:center;" id="judul-form">Edit Data</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="<?php echo base_url('update-data-umum'); ?>" id="form-data-umum" enctype="multipart/form-data" method="post">
                                                            ...
                                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="file-upload-inner ts-forms">
                                                                    <div class="input prepend-small-btn">
                                                                        ...
                                                                        <input type="text" value="<?= $dataumum['logo_daerah'] ?>" id="logo_daerah" name="logo_daerah" readonly placeholder="Tidak ada File dipilih" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
