                        ...
                        <div class="hpanel email-compose" style = "min-height:550px;">
                            <div class="panel-heading hbuilt">
                                <div class="p-xs h4" style="text-align:center;">
                                    REALISASI CAPAIAN KINERJA PER KEGIATAN (PERUBAHAN)
                                </div>
...
<script type="text/javascript">
    ...
    $(document).on("click", ".cetakLaporan", function() {
        ...
        if(output == 'pdf'){
            window.open('<?php echo base_url('realisasi-detail-kegiatan-perubahan-pdf/'); ?>'+skpd+'/'+keg+'/'+id+'?tgl='+tgl+'&orientation='+ori+'&margins='+mar+'&spacing='+space, '_blank');	
        }else{
            window.open('<?php echo base_url('realisasi-detail-kegiatan-perubahan-excel/'); ?>'+skpd+'/'+keg+'/'+id+'?tgl='+tgl, '_blank');	
        }
