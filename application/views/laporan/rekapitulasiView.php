                        ...
                        <div class="hpanel email-compose" style = "min-height:550px;">
                            <div class="panel-heading hbuilt">
                                <div class="p-xs h4" style="text-align:center;">
                                    REKAPITULASI CAPAIAN KINERJA SKPD
                                </div>
...
<script type="text/javascript">
    ...
    $(document).on("click", ".cetakLaporan", function() {
        ...
        if(output == 'pdf'){
            window.open('<?php echo base_url('rekapitulasi-capaian-pdf/'); ?>'+skpd+'/'+id+'?tgl='+tgl+'&orientation='+ori+'&margins='+mar+'&spacing='+space, '_blank');	
        }else{
            window.open('<?php echo base_url('rekapitulasi-capaian-excel/'); ?>'+skpd+'/'+id+'?tgl='+tgl, '_blank');		
        }
